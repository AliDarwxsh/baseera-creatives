  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "lg:hover:bg-gradient-to-br lg:hover:from-background lg:hover:to-accent/10",
        "transition-all duration-300"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="rounded-full bg-accent/20 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-secondary mb-4 sm:mb-5">
        {icon}
      </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-muted/30" id="features" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          <div className="baseera-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>Services</span>
          </div>
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Cinematic Narratives, <br className="hidden sm:block" />Cultural Impact
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            We craft films that move people, build loyalty, and establish authority in cultural storytelling.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Human-centric content strategies that connect authentically with your audience and build lasting relationships."
            index={0}
          />
          <FeatureCard
            ...
            description="Social-first content production that transforms brand stories into compelling visual narratives."
            index={1}
          />
          <FeatureCard
            ...
            description="We don't just create content—we craft cultural moments that resonate and leave lasting impact."
            index={2}
          />
          <FeatureCard
            ...
            description="Every project is designed to carve space for your brand to leave a meaningful legacy."
            index={3}
          />
          <FeatureCard
            ...
            description="Limited clients, unlimited attention. Award-winning team touches every project personally."
            index={4}
          />
          <FeatureCard
            ...
            title="Value-Driven Films"
            description="Films that endure because they're rooted in authentic values and genuine human connection."
            index={5}
          />
        </div>
      </div>
